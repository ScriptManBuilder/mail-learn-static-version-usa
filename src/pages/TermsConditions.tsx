    ...
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          ...
          the terms and provisions of this agreement. These terms apply to all digital Email Marketing courses, educational content, and 
      ...
      <Section>
        ...
        <Paragraph>
          This Email Marketing course platform is operated by {COMPANY_INFO.name}. 
      ...
      <Section>
        <SectionTitle>3. Digital Email Marketing Course Pricing</SectionTitle>
        <Paragraph>
          Our Email Marketing courses are available at the following price points: {formatPrice(6.99)}, {formatPrice(9.99)}, {formatPrice(19.99)}, {formatPrice(29.99)}, {formatPrice(39.99)}, {formatPrice(49.99)}, {formatPrice(59.99)}, {formatPrice(69.99)}, {formatPrice(79.99)}, {formatPrice(89.99)}, and {formatPrice(99.99)}. 
      ...
      <Section>
        ...
        <Paragraph>
          We accept major credit and debit cards for Email Marketing course purchases. Your payment information is processed securely through our payment processors using 256-bit SSL encryption.
        </Paragraph>
        <Paragraph>
          <strong>Billing Descriptor:</strong> Charges will appear on your credit card statement as "EMAIL MARKETING COURSES" or "MAIL-LEARN.COM". 
      ...
      <Section>
        ...
        <Paragraph>
          Upon successful payment, you will receive immediate access to your purchased Email Marketing courses through your account dashboard. 
      ...
      <Section>
        ...
        <Paragraph>
          All Email Marketing course content, including videos, text, images, and downloadable materials, are the intellectual property of 
      ...
      <Section>
        ...
        <Paragraph>
          Due to the digital nature of our Email Marketing courses, all sales are final. However, we offer a 7-day satisfaction guarantee. 
      ...
      <Section>
        ...
        <Paragraph>
          We continuously update our Email Marketing course content to reflect the latest developments in digital marketing. 
      ...
      <Section>
        ...
        <Paragraph>
          {COMPANY_INFO.name} provides Email Marketing courses for educational purposes only. We make no guarantees about 
